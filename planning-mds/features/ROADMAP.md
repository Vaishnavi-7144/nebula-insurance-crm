...
| [F0036 — Form Engine and Form-State Preservation (RHF + AJV + Widget Registry)](./F0036-dynamic-product-attribute-form-engine/README.md) | Platform Foundation / CRM Release MVP Enabler | Two workstreams: (A) realizes the accepted ADR-021 form engine F0034 shipped without — schema-driven, RHF-managed LOB product attributes (Cyber first); (B) migrates the hand-rolled CRUD forms to RHF. Both register with F0035 form-state preservation, fully closing the gap where preservation was wired to zero forms. Unblocks dependable product-attribute entry for the F0019 quote workflow. |
